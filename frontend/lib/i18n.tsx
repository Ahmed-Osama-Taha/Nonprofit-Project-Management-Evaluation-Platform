...
const EN: Dict = {
  ...
  "sig.anon": "Anonymising network",
  "prof.connection": "Connection",
  "net.local": "Local network",
  "net.residential": "Residential ISP",
  "net.hosting": "Hosting / datacenter",
  "net.vpn": "VPN",
  "net.proxy": "Public proxy",
  "net.tor": "Tor exit node",
  "net.unknown": "Unknown",
  // Intake wizard
  "wizard.step": "Step",
  "wizard.of": "of",
...
const AR: Dict = {
  ...
  "sig.anon": "شبكة إخفاء هوية",
  "prof.connection": "الاتصال",
  "net.local": "شبكة محلية",
  "net.residential": "مزود إنترنت منزلي",
  "net.hosting": "استضافة / مركز بيانات",
  "net.vpn": "VPN",
  "net.proxy": "بروكسي عام",
  "net.tor": "عقدة خروج Tor",
